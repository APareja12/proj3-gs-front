function About(props) {
  return (
    <>
    <h1>About</h1>
    <p>A silent film is a film with no synchronized recorded sound (and in particular, no audible dialogue). Though silent films convey narrative and emotion visually, various plot elements (such as a setting or era) or key lines of dialogue may, when necessary, be conveyed by the use of title cards.
